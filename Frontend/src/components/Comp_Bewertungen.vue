<template>
  ...
  >
      ...
      <div class="flex items-center xl:col-span-1">
        <div class="flex items-center">
          <StarIcon
            ...
            :key="rating"
            :class="[
              review.anzahl_sterne > rating ? 'text-yellow-400' : 'text-gray-200',
        ...
        <p class="ml-3 text-sm text-gray-700">
          {{ review.anzahl_sterne }}<span class="sr-only"> out of 5 stars</span>
        </p>
      </div>

      <div class="mt-4 lg:mt-6 xl:mt-0 xl:col-span-2">
        <h3 class="text-sm font-medium text-gray-900">{{ review.titel }}</h3>
    ...
    >
      <p class="font-medium text-gray-900">{{ review.vorname }} {{ review.nachname }}</p>
      <time
